  ...
  <div class="g3">
    <div class="card acc"><span class="tag y">Стоимость работ</span>
      <ul>
        ...
        <li>Альтернатива: вы ведёте кабинеты сами, и от квартального оборота начисляются бонусные рубли
        (Ozon до 18 %, Urban до 13 %, WB до 16 %). С сопровождением это не совмещается</li>
      </ul></div>
...
<footer>
  <span>Церебро Таргет · направление Click Out · работаем через агентский кабинет на Ozon Performance, Яндекс Urban Ads и WB Media</span>
